...
if (isset($_POST['export'])) {
    ...
    foreach ($invoices as $invoice) {
        ...
        if ($invoice['status'] === 'partial') {
            $balance = $invoice['total_amount'] * 0.5;
        }
...
<body>
    ...
    <a href="../invoice/invoice_add.php"><button class="btn"><i class="material-icons">add</i> Add New Invoice</button></a>
    <a href="../invoice/client_add.php"><button class="btn"><i class="material-icons">person_add</i> Add New Client</button></a>
...
<td>
                            ...
                            <a href="client_edit.php?name=<?php echo urlencode($invoice['customer_name']); ?>" class="client-link">
