...
// Fetch categories, units, and statuses for dropdowns
...
$statuses = $pdo->query("SELECT status_id, status_name FROM product_status ORDER BY status_name")->fetchAll(); // Changed to product_status
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO product_inventory (
                product_id, quantity, unit_price, updated_at
            ) VALUES (?, ?, ?, NOW())");
    ...
    <script>
        ...
        // User dropdown toggle (enhanced version)
        ...
        // Image Upload (unchanged but with null checks)
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Search functionality for dropdowns (if needed)
