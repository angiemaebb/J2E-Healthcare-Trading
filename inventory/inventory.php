...
// Fetch products from database with inventory information
$query = "SELECT p.*, c.category_name, pi.quantity, pi.unit_price 
          FROM products p 
        ...
        <div class="nav-right">
            <div class="user-info">
                ...
                <div class="user-dropdown" id="userDropdown">
                    ...
                    <a href="../authenticate/logout.php"><i class="fas fa-sign-out-alt"></i> Logout</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="menu">
            <div class="menu-buttons">
                <a href="../inventory/product_add.php"><button class="menu-btns"><i class="fas fa-plus"></i> Add New
                        Product</button></a>
                <a href="../category/manageCategory.php"><button class="menu-btns"><i class="fas fa-tag"></i> Manage
                        Categories</button></a>
            </div>

            <div class="search-container">
                <input type="text" id="searchInput" class="search-input" placeholder="Search product or category...">
            </div>
        </div>
            ...
            <tbody>
                ...
                if (count($result) > 0) {
                    foreach ($result as $row) {
                        $image_path = !empty($row['image_path']) ? "../" . $row['image_path'] : "../images/sample user profile pic.jpg";
                ?>
                        <tr>
                            <td><input type="checkbox" class="product-checkbox" value="<?php echo $row['product_id']; ?>"></td>
                            <td><img src="<?php echo $image_path; ?>" alt="Product" class="product-image"></td>
                            ...
                            <td>
                                <a href="product_edit.php?id=<?php echo $row['product_id']; ?>" class="menu-btns" style="text-decoration: none; padding: 5px 10px;">
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            rows.forEach(row => {
                ...
                const category = row.querySelector('td:nth-last-child(2)').textContent.toLowerCase();
